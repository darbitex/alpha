/// Darbitex Router v3 — Multi-hop swap routing.
/// Supports plain pools (pool::swap) and wrapped hooked pools (hook_wrapper::swap).
/// Aggregators: use swap functions directly for composability,
/// or entry functions for end-user transactions.
