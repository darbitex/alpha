...
/// Soulbound (non-transferable). Access restricted to friend modules.
///
/// Audit fixes:
///   [B-C1] Per-pool LP tracking (not global) — prevents cross-pool drain
///   [LP-H2] mint/burn restricted to friend modules only
///   [B-M5] init checks @darbitex caller
